	...
	echo "<div id='resume' class='container'>";
		...
		try {
			...
			while ($row = $result->fetch(PDO::FETCH_ASSOC)) {
				...
				echo "<div class='row'>";
				echo "<div class='col-sm'>";
				echo "<p class='text-left' style='background:gainsboro'>&nbsp; Revenu global net</p>";
				echo "</div>";
				echo "<div class='col-sm'>";
				...
				echo "<div class='row'>";
				echo "<div class='col-sm'>";
				echo "<p class='text-left' style='background:gainsboro'>&nbsp; Dernier admis en 2025</p>";
				echo "</div>";
				echo "<div class='col-sm'>";
				echo "<p class='text-left'>" . $montant->format($Dernier2025) . " à " . $CHUDernier2025 . "</p>";		
				echo "</div>";
				echo "<div class='col-sm'>";
