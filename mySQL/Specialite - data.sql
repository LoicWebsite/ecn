...
--
-- Hôte : localhost
-- Généré le : sam. 02 nov. 2024 à 15:42
...
('BM', 'Biologie médicale', 87, 107, 107, 107, 107, 0, 0, 0, NULL, NULL, 7813, 'AMIENS', 10500, 'MARTINIQUE/POINTE A PITRE', 9293, 'AP-HP Paris', 8931, 'AMIENS', 8780, 'DIJON', 8714, ' LILLE ', 8695, ' MONTPELLIER ', 8363, ' SAINT ETIENNE ', 81419, 'medecine', 'transversale', 'ville', 4),
...
('COT', 'Chirurgie orthopédique et traumatologique', 107, 129, 126, 123, 121, 1, 1, 1, NULL, NULL, 3170, 'CLERMONT-FERRAND', 3573, 'MARTINIQUE/POINTE A PITRE', 3870, 'LA REUNION', 3838, 'BESANCON', 4008, 'LIMOGES', 3834, ' LIMOGES ', 3887, ' LA REUNION ', 3467, ' LIMOGES ', 137177, 'chirurgie', 'chirurgicale', 'hopital', 6),
...
('GEN', 'Génétique médicale', 21, 25, 21, 21, 20, 0, 0, 0, NULL, NULL, 7495, 'LIMOGES', 9515, 'AMIENS', 9288, 'MARTINIQUE/POINTE A PITRE', 8459, 'LA REUNION', 7008, 'LIMOGES', 7837, ' AMIENS ', 8470, ' AMIENS ', 5801, ' BESANCON ', 0, 'medecine', 'transversale', 'hopital', 4),
...
('HGE', 'Hépato-gastro-entérologie', 122, 145, 138, 132, 127, 1, 2, 0, 1, 1, 3343, 'MARTINIQUE/POINTE A PITRE', 4234, 'MARTINIQUE/POINTE A PITRE', 4465, 'CLERMONT-FERRAND', 4475, 'BESANCON', 3643, 'LIMOGES', 3898, ' LIMOGES ', 4332, ' MARTINIQUE/POINTE A PITRE ', 3971, ' LIMOGES ', 119657, 'medecine', 'organe', 'ville', 5),
('MCA', 'Médecine cardiovasculaire', 169, 199, 193, 184, 178, 1, 5, 1, 1, 2, 2694, 'AMIENS', 3142, 'LIMOGES', 3363, 'MARTINIQUE/POINTE A PITRE', 3394, 'LIMOGES', 2567, 'AMIENS', 3445, ' LIMOGES ', 2678, ' MARTINIQUE/POINTE A PITRE ', 2887, ' LIMOGES ', 128139, 'medecine', 'organe', 'ville', 5),
...
('MLE', 'Médecine légale et expertises médicales', 23, 28, 26, 26, 26, 0, 0, 0, NULL, NULL, 7444, 'MARTINIQUE/POINTE A PITRE', 7854, 'MARTINIQUE/POINTE A PITRE', 9062, 'MARTINIQUE/POINTE A PITRE', 8876, 'AMIENS', 7160, 'MARTINIQUE/POINTE A PITRE', 7345, ' CAEN ', 7618, ' LIMOGES ', 7441, ' CAEN ', 64220, 'medecine', 'transversale', 'hopital', 4),
...
('MUR', 'Médecine d’urgence', 414, 487, 483, 474, 471, 2, 7, 4, 5, 5, 6288, 'AMIENS', 8007, 'BESANCON', 9247, 'CAEN', 8452, 'AP-HP Paris', 8399, 'REIMS', 8708, ' DIJON ', 8693, ' BESANCON ', 8285, ' LIMOGES ', 90272, 'medecine', 'transversale', 'hopital', 4),
