  ...
  <body id="hautdepage" class="m-2">
	...
	<nav style='margin-top:80px;' aria-label="breadcrumb">
	  <ol class="breadcrumb">
		...
		<li class="breadcrumb-item active" aria-current="page">Affectations 2022</li>
	  </ol>
	</nav>
	...
	<?php
		...
		echo "Rangs limites CELINE 2022 actualisés (affectations terminées)";
		echo "</h1>";
...
//					$href = " onclick='return false' ondblclick='window.open(" . $lien . ", &apos;Fenêtre CELINE&apos;)' ";
		...
		if ($heure != "00h00") {
			...
			echo "<br/><br/><p>Vous pouvez aussi consulter les dernières données enregistrées en choisissant <a href='liste-specialite.php?reference=2022'>Voir les spécialités</a> dans le <a href='questionnaire-choix-specialite.php'>questionnaire</a>.</p></div>";
		}
